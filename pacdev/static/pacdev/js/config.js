var Config={
	'Protected Areas Commission':{
		...
		'layers':{
			'keys':[],
			'boundary':{'type':'polygon','src_url':'/static/pacdev/data/guyana/guyana_boundary.geojson','style':new ol.style.Style({stroke: new ol.style.Stroke({color: '#83ad35',width: 2}),fill: new ol.style.Fill({color: 'rgba(0,200,0,0.1)'}),}),},
		},
		...
		'Hinterland Parks':{
			...
			'layers':{
				'keys':[],
				'boundary':{'type':'polygon','src_url':'/static/pacdev/geojson/hinterland_boundaries.geojson','style':new ol.style.Style({stroke: new ol.style.Stroke({color: '#83ad35',width: 2}),fill: new ol.style.Fill({color: 'rgba(0,200,0,0.1)'}),}),},
			},
			'Kaieteur National Park':{
				...
				'layers':{
					...
					'falls3d':{'type':'points','src_url':'/static/pacdev/data/kaieteur/falls.geojson',},
				},
			},
			'Shell Beach':{
				...
				'layers':{
					...
					'sinewave':{'type':'points','src_url':'/static/pacdev/data/shellbeach/sinewave.geojson',},
				},
			},
			'Kanuku Mountains':{
				...
				'layers':{
					...
					'kanuku_panorama':{'type':'points','src_url':'/static/pacdev/data/kanuku/kanuku3d.geojson',},
					'rupununi_panorama':{'type':'points','src_url':'/static/pacdev/data/kanuku/rupununi3d.geojson',},
				},
			}
		},
		'Urban Parks':{
			...
			'layers':{
				'keys':[],//'boundary',
				'boundary':{'type':'polygon','src_url':'/static/pacdev/geojson/urbanparks_boundary.geojson','style':new ol.style.Style({stroke: new ol.style.Stroke({color: '#83ad35',width: 2}),fill: new ol.style.Fill({color: 'rgba(0,200,0,0.1)'}),}),},
			},
			'Guyana Zoo':{
		...
		'Related Areas':{
			...
			'layers':{
				'keys':[],
				'boundary':{'type':'polygon','src_url':'/static/pacdev/geojson/related_boundary.geojson','style':new ol.style.Style({stroke: new ol.style.Stroke({color: '#83ad35',width: 2}),fill: new ol.style.Fill({color: 'rgba(0,200,0,0.1)'}),}),},
			},
			'Konashens':{
