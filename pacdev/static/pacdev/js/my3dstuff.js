var My3DStuff=function(){
	...
	me.start=function(mediapath){
		...
		var sides = [
			{
				url: mediapath[0]+'/pacdev/data/'+mediapath[1]+'/'+mediapath[2]+'/negx.png',
				position: [ -512, 0, 0 ],
				rotation: [ 0, Math.PI / 2, 0 ]
			},
			{
				url: mediapath[0]+'/pacdev/data/'+mediapath[1]+'/'+mediapath[2]+'/posx.png',
				position: [ 512, 0, 0 ],
				rotation: [ 0, -Math.PI / 2, 0 ]
			},
			{
				url: mediapath[0]+'/pacdev/data/'+mediapath[1]+'/'+mediapath[2]+'/posy.png',
				position: [ 0,  512, 0 ],
				rotation: [ Math.PI / 2, 0, Math.PI ]
			},
			{
				url: mediapath[0]+'/pacdev/data/'+mediapath[1]+'/'+mediapath[2]+'/negy.png',
				position: [ 0, -512, 0 ],
				rotation: [ - Math.PI / 2, 0, Math.PI ]
			},
			{
				url: mediapath[0]+'/pacdev/data/'+mediapath[1]+'/'+mediapath[2]+'/posz.png',
				position: [ 0, 0,  512 ],
				rotation: [ 0, Math.PI, 0 ]
			},
			{
				url: mediapath[0]+'/pacdev/data/'+mediapath[1]+'/'+mediapath[2]+'/negz.png',
				position: [ 0, 0, -512 ],
				rotation: [ 0, 0, 0 ]
			}
		];
