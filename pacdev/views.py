...
from pacdev.models import *

FORMAT = '%(asctime)-15s %(message)s'
logging.basicConfig(filename='/var/www/dev/pacdev/pacdev.log',level=logging.DEBUG, format=FORMAT)
...
def hinterland(request):
	logging.debug('pacdev.hinterland')
	return render_to_response(
		'hinterland.html',{
...
def urbanparks(request):
	logging.debug('pacdev.urbanparks')
	return render_to_response(
		'urbanparks.html',{
